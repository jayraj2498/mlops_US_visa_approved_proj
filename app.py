...
# here we are taking data from  user 
class DataForm:
...
# here we are taking data from form 
...
# training route here it will start the training 
@app.get("/train")
...
# prediction route here it will start the prediction 
@app.post("/")
