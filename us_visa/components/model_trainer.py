...
class ModelTrainer: 
    def __init__(self , data_transformation_artifact:DataTransformationArtifact  , model_trainer_config: ModelTrainerConfig) : 
        ...
        """
        :param data_ingestion_artifact: Output reference of data transformation artifact stage
        :param data_transformation_config: Configuration for model trainer config 
        """ 
    ...
    def initiate_model_trainer(self, ) -> ModelTrainerArtifact:  
        ...
        logging.info(f"Entered initiate_model_trainer method of ModelTrainer class")  
